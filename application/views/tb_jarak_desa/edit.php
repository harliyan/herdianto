<?php echo form_open('jarak_desa/edit/'.$tb_jarak_desa['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_desa_awal" class="form-control">
				...
				{
					$selected = ($value == $tb_jarak_desa['id_desa_awal']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_desa_akhir" class="form-control">
				...
				{
					$selected = ($value == $tb_jarak_desa['id_desa_akhir']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="jarak" value="<?php echo ($this->input->post('jarak') ? $this->input->post('jarak') : $tb_jarak_desa['jarak']); ?>" class="form-control" id="jarak" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="tahun" value="<?php echo ($this->input->post('tahun') ? $this->input->post('tahun') : $tb_jarak_desa['tahun']); ?>" class="form-control" id="tahun" />
