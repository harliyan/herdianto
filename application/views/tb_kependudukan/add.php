<?php echo form_open('kependudukan/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="laki_laki" value="<?php echo $this->input->post('laki_laki'); ?>" class="form-control" id="laki_laki" />
		</div>
	</div>
	<div class="form-group">
		<label for="perempuan" class="col-md-4 control-label">Perempuan</label>
		<div class="col-md-8">
			<input type="text" name="perempuan" value="<?php echo $this->input->post('perempuan'); ?>" class="form-control" id="perempuan" />
		</div>
	</div>
	<div class="form-group">
